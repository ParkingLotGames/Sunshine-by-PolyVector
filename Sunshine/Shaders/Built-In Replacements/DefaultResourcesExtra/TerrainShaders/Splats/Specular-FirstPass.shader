Shader "Sunshine/Nature/Terrain/Specular" {
	Properties {
	...
	Dependency "AddPassShader" = "Hidden/Sunshine/TerrainEngine/Splatmap/Specular-AddPass"
	Dependency "BaseMapShader" = "Hidden/Sunshine/TerrainEngine/Splatmap/Specular-Base"
