Shader "Sunshine/Nature/Terrain/Diffuse" {
	...
	Dependency "AddPassShader" = "Hidden/Sunshine/TerrainEngine/Splatmap/Diffuse-AddPass"
	Dependency "BaseMapShader" = "Sunshine/Legacy Shaders/Diffuse"
	Dependency "Details0"      = "Hidden/Sunshine/TerrainEngine/Details/Vertexlit"
	Dependency "Details1"      = "Hidden/Sunshine/TerrainEngine/Details/WavingDoublePass"
	Dependency "Details2"      = "Hidden/Sunshine/TerrainEngine/Details/BillboardWavingDoublePass"
