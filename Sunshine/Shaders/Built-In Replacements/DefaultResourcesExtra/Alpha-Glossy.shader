Shader "Sunshine/Legacy Shaders/Transparent/Specular" {
Properties {
...
#pragma target 3.0
#pragma surface surf BlinnPhong alpha vertex:sunshine_surf_vert exclude_path:prepass
...
Fallback "Legacy Shaders/Transparent/Specular"
}
